function addData(db){
  return new Promise(function(resolve, reject) {
    ...
    db.product.create({title:"Set of dumbbels, 10Lbs", price:55, availability:25, image:"/dumbbells10.jpg"});
    db.product.create({title:"Olympic barbell", price:60, availability:0, image:"/barbell.jpg"});
