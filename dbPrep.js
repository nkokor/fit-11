function addData(db){
  return new Promise(function(resolve, reject) {
    ...
    db.product.create({title:"Set of dummbells, 20Lbs", price:112, availability:0, image:"/dumbbells20.jpg"});
    db.product.create({title:"Dummbells, full set", price:380, availability:3, image:"/dumbbellsset.jpg"});
    ...
    db.product.create({title:"Set of dumbbels, 10Lbs", price:55, availability:18, image:"/dumbbells10.jpg"});
